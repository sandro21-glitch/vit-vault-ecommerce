...
const CartModal = () => {
  ...
  return (
    <div
      className="absolute top-[100%] py-5 right-0 w-[330px] z-[-1] group-hover/modal:z-[9999] opacity-0
     group-hover/modal:opacity-100  transition-all ease-in duration-300 lg:block hidden"
    >
